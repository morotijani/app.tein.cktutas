...
?>
    <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary" style="background-image: url(<?= PROOT; ?>dist/media/bg-1.jpg); background-position: center; background-repeat: no-repeat; background-size: cover;">
        ...
        <?php include ('news/news.left.side.php'); ?>
    </div>
    
<?php include ('news/news.footer.php'); ?>
