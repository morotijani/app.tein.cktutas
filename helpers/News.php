	                ...
	                $this->output .= "
	                	<tr>
		                    ...
		                    <td>
		                        ...
		                        <a class='badge bg-secondary text-decoration-none' href='" . PROOT . "blog/add/edit/" . $new['id'] . "'>Edit</a>
								  	...
								  	<div class='modal-dialog modal-dialog-centered modal-sm'>
								    	<div class='modal-content' style='background-color: rgb(51, 51, 51)'>
								    		<div class='modal-body'>
								        		...
								        		<button type='button' class='btn btn-sm btn-secondary' data-bs-dismiss='modal'>Close</button>
								        		<a href='" . PROOT . "blog/add/delete/" . $new['id'] . "' class='btn btn-sm btn-outline-secondary'>Confirm Delete.</a>
								      		</div>
								    	</div>
								 	</div>
								</div>
